export default {
    ...
    REQUEST_VALIDATE_USER: 'user/REQUEST_VALIDATE_USER',
    SUCCESS_VALIDATE_USER: 'user/SUCCESS_VALIDATE_USER',
    FAILURE_VALIDATE_USER: 'user/FAILURE_VALIDATE_USER',
    LOGOUT_USER: 'user/LOGOUT_USER',

    REQUEST_GET_CASES: 'cases/REQUEST_GET_CASES',
    SUCCESS_GET_CASES: 'cases/SUCCESS_GET_CASES',
    FAILURE_GET_CASES: 'cases/FAILURE_GET_CASES',
