...
export default function* root() {
  yield all([
    ...
    takeEvery(TYPES.REQUEST_UPDATE_BENEFICIARY_PHOTO_CASE, asyncPostCaseDocuments),
    takeEvery(TYPES.REQUEST_UPDATE_PAN_CASE, asyncPostCaseDocuments),
    takeEvery(TYPES.REQUEST_SAVE_FORM, asyncPostCaseDocuments),
    takeEvery(TYPES.REQUEST_UPDATE_AUDIO_VIDEO_CASE, asyncPostCaseDocuments),
    takeEvery(TYPES.REQUEST_SUBMIT_CASE, asyncSubmitCaseDocuments),
